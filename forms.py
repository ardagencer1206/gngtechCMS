...
class ContactContentForm(FlaskForm):
    ...
    intro_tr = TextAreaField('Giriş Metni (TR)', validators=[DataRequired()])
    intro_en = TextAreaField('Giriş Metni (EN)', validators=[DataRequired()])
    headline_a_tr = StringField('Adres Başlığı İlk Kısım (TR)', validators=[DataRequired()])
    headline_a_en = StringField('Adres Başlığı İlk Kısım (EN)', validators=[DataRequired()])
    headline_b_tr = StringField('Adres Başlığı İkinci Kısım (TR)', validators=[DataRequired()])
    headline_b_en = StringField('Adres Başlığı İkinci Kısım (EN)', validators=[DataRequired()])
    address_label_tr = StringField('Adres Etiketi (TR)', validators=[DataRequired()])
    address_label_en = StringField('Adres Etiketi (EN)', validators=[DataRequired()])
    address_value_tr = TextAreaField('Adres Metni (TR)', validators=[DataRequired()])
    address_value_en = TextAreaField('Adres Metni (EN)', validators=[DataRequired()])
    general_label_tr = StringField('Genel İletişim Etiketi (TR)', validators=[DataRequired()])
    general_label_en = StringField('Genel İletişim Etiketi (EN)', validators=[DataRequired()])
    general_email = StringField('Genel İletişim E-posta', validators=[DataRequired()])
    press_label_tr = StringField('Basın İletişim Etiketi (TR)', validators=[DataRequired()])
    press_label_en = StringField('Basın İletişim Etiketi (EN)', validators=[DataRequired()])
    press_email = StringField('Basın İletişim E-posta', validators=[DataRequired()])
    phone_label_tr = StringField('Telefon Etiketi (TR)', validators=[DataRequired()])
    phone_label_en = StringField('Telefon Etiketi (EN)', validators=[DataRequired()])
    phone_number = StringField('Telefon Numarası', validators=[DataRequired()])
    coords_label_tr = StringField('Koordinatlar Etiketi (TR)', validators=[DataRequired()])
    coords_label_en = StringField('Koordinatlar Etiketi (EN)', validators=[DataRequired()])
    coords_value_tr = StringField('Koordinatlar Değeri (TR)', validators=[DataRequired()])
    coords_value_en = StringField('Koordinatlar Değeri (EN)', validators=[DataRequired()])
    map_pin_title_tr = StringField('Harita İğne Başlığı (TR)', validators=[DataRequired()])
    map_pin_title_en = StringField('Harita İğne Başlığı (EN)', validators=[DataRequired()])
